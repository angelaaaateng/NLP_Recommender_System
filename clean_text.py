...
def vectorize_filtered_words(post_titles, filtered_word_list):
    ...
    for title in post_titles:
        ...
        if len(word_vecs) == 0:
            ...
            print("* Vectorize and store news titles")
...
def vectorize_and_store_existing_titles(model):
    ...
    print("* Vectorize and store existing titles")
...
def clean_and_store_text(title, model):
    '''
    For text cleaning to output title vectors
